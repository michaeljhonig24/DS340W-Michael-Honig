...
def get_data(parquetpath, bs):
    ...
    train_dataset = FourTupleDataset(train_fea_re, train_lab_re)
    val_dataset = FourTupleDataset(va_fea_re, va_lab_re)
    tes_dataset = FourTupleDataset(tes_fea_re, tes_lab_re)
